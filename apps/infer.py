...
if __name__ == "__main__":
    ...
    dataset_param = {
        'image_dir': args.in_dir, # ./examples
        'seg_dir': args.seg_dir,
        'colab': args.colab,
        'has_det': True,  # w/ or w/o detection
        'hps_type': args.hps_type  # pymaf/pare/pixie # pixie
    }
    ...
    for data in pbar:
        ...
        for i in loop_smpl:
            ...
            print("smpl_verts",smpl_verts.shape)
            print("smpl_faces",in_tensor["smpl_faces"].shape)
            ...
            print("in_tensor[T_normal_F]=",in_tensor["T_normal_F"])
